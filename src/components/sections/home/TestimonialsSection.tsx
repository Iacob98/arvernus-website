          ...
          {testimonials.length > 1 && (
            <>
              <button
                ...
                className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 hidden h-10 w-10 items-center justify-center rounded-full bg-white shadow-md border border-border text-foreground transition hover:bg-gray-50 disabled:opacity-0 disabled:pointer-events-none lg:flex"
              ...
              <button
                ...
                className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 hidden h-10 w-10 items-center justify-center rounded-full bg-white shadow-md border border-border text-foreground transition hover:bg-gray-50 disabled:opacity-0 disabled:pointer-events-none lg:flex"
