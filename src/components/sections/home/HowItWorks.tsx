...
const steps = [
  {
    ...
    description: "Nutzen Sie unseren Rechner oder das Kontaktformular für eine unverbindliche Anfrage.",
    icon: (
  ...
  },
  {
    ...
    description: "Unsere Experten besichtigen Ihr Objekt und analysieren die optimale Lösung.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    description: "Sie erhalten ein maßgeschneidertes Angebot inkl. Fördermittelberechnung.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    number: "04",
    title: "Installation",
    description: "Professionelle Installation durch unser zertifiziertes Fachpersonal.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
